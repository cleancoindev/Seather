...
#   c) node1 mines 32 blocks, so now node 0 has 500000STR, node 1 has 4250STR, node2 has none.
#   d) node0 sends 601 STR to node2, in two transactions (301 STR, then 300 STR).
