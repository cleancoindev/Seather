Contributing to Seather Core
==================================

The Seather Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Seather Core project, and is not to be
confused with overall Seather Network Protocol consensus changes.

Whether a pull request is merged into Seather Core rests with the project merge
...
Patches that change Seather consensus rules are considerably more involved than
...
Where a patch set proposes to change the Seather consensus, it must have been
...
The project leader is the release manager for each Seather Core release.
