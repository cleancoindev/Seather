...
RESOURCES += src/qt/seather.qrc src/qt/seather_locale.qrc

TRANSLATIONS += src/qt/locale/seather_bg.ts \
                src/qt/locale/seather_de.ts \
                src/qt/locale/seather_en.ts \
                src/qt/locale/seather_es.ts \
                src/qt/locale/seather_fi.ts \
                src/qt/locale/seather_fr.ts \
                src/qt/locale/seather_it.ts \
                src/qt/locale/seather_ja.ts \
                src/qt/locale/seather_pl.ts \
                src/qt/locale/seather_pt.ts \
                src/qt/locale/seather_ru.ts \
                src/qt/locale/seather_sk.ts \
                src/qt/locale/seather_sv.ts \
                src/qt/locale/seather_vi.ts \
                src/qt/locale/seather_zh_CN.ts \
                src/qt/locale/seather_zh_TW.ts
