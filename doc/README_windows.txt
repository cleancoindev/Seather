...
Intro
-----
Seather (STR) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Seather utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run seather-qt.exe.

Seather Core is the original Seather client and it builds the backbone of the network.
However, it downloads and stores the entire history of Seather transactions;
