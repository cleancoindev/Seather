...
In order to support loading of multiple wallets in seather-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is seather.cpp.
...
Changes to seather.cpp
----------------------
seather.cpp is the entry point into seather-qt, and as such, will require some minor modifications to provide hooks for
