...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Seather server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Seather features */
        {"seather", "masternode", &masternode, true, true, false},
        {"seather", "listmasternodes", &listmasternodes, true, true, false},
        {"seather", "getmasternodecount", &getmasternodecount, true, true, false},
        {"seather", "masternodeconnect", &masternodeconnect, true, true, false},
        {"seather", "masternodecurrent", &masternodecurrent, true, true, false},
        {"seather", "masternodedebug", &masternodedebug, true, true, false},
        {"seather", "startmasternode", &startmasternode, true, true, false},
        {"seather", "createmasternodekey", &createmasternodekey, true, true, false},
        {"seather", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"seather", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"seather", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"seather", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"seather", "getmasternodescores", &getmasternodescores, true, true, false},
        {"seather", "mnbudget", &mnbudget, true, true, false},
        {"seather", "preparebudget", &preparebudget, true, true, false},
        {"seather", "submitbudget", &submitbudget, true, true, false},
        {"seather", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"seather", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"seather", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"seather", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"seather", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"seather", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"seather", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"seather", "checkbudgets", &checkbudgets, true, true, false},
        {"seather", "mnsync", &mnsync, true, true, false},
        {"seather", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> seather-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22501/\n";
}
