...
// Copyright (c) 2018 The Seather developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000f002a4d9703c2735e77f733d4399f1b232ee42887c5f297ab50090fff81"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1527918358, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "Reborn For New Life Seather Coin 2018";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1527918358;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1461271;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000f002a4d9703c2735e77f733d4399f1b232ee42887c5f297ab50090fff81"));
        ...
        // Seather script addresses start with '3'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 6);
        // Seather private keys start with 'K'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 46);
        // Seather BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Seather BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // Seather BIP44 coin type is '222' (0x800000de)
...
public:
    CTestNetParams()
    {
        ...
        // Testnet Seather addresses start with 's'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 125);
        // Testnet Seather script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet Seather BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Seather BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet Seather BIP44 coin type is '1' (All coin's testnet default)
