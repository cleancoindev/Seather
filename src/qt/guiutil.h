...
/** Utility functions used by the Seather Qt UI.
 */
namespace GUIUtil
{
...
// Render STR addresses in monospace font
...
// Parse "seather:" URI into recipient object, return true on successful parsing
