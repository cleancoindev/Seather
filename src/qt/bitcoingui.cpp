                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Seather Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a STR address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and seather: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Seather Core"), this);
    aboutAction->setStatusTip(tr("Show information about Seather Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Seather"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your STR addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified STR addresses"));
    ...
    openAction->setStatusTip(tr("Open a seather: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Seather Core help message to get a list with possible Seather command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Seather Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Seather network", "", count));
}
...
{
    QString strTitle = tr("Seather Core"); // default title
